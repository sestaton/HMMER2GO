...
Perl must be installed to use HMMER2GO, and there are a couple of external modules required. The nstallation can be done with the following  command (note that this requires [git](http://git-scm.com/)):
